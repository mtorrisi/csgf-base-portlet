...
public class ConfigurationActionImpl implements ConfigurationAction {
	...
	private void saveInfrastructure(ActionRequest actionRequest,
		...
		infrastructure.setETokenServer(ParamUtil.getString(
				actionRequest, "pref_pxServerHost", ""));
		infrastructure.setETokenServerPort(ParamUtil.getString(
				actionRequest, "pref_pxServerPort", ""));
		...
		infrastructure.setPxServerSecure(ParamUtil.getBoolean(
				actionRequest, "pref_pxServerSecure"));
		infrastructure.setResourcemanagerList(ParamUtil.getString(
				actionRequest, "pref_wmsHosts", "").split(";"));
		infrastructure.setRFC(ParamUtil.getBoolean(actionRequest,
				"pref_pxRFC"));
		...
		if (infraId.equals("")) {
			...
			for (int i = 0; i < infrastructures.size(); i++) {
				AppInfrastructureInfo oldInfrastructure = infrastructures.get(i);
	...
	private void savePilot(ActionRequest actionRequest, String portletResource)
		...
		Utils.string2File(HostnamePortlet.pilotScript, pilotScript);
